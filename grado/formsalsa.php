...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll-trigger" href="index.html">SANDWICHTIAN</a>
  ...
  <header class="masthead text-black text-center" style="background-image: url('img/salsa.jpg'); background-repeat: no-repeat;background-position: center;background-size: cover;">
       <!-- Icon Divider -->
  ...
  <div class="form-group">
    <label for="exampleInputEmail1">Nombre de la salsa</label>
    <input type="text" class="form-control text-center" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Ingrese nombre del condimento">
  </div>
  <div class="form-group">
    <label for="exampleInputPassword1">Precio</label>
    <input type="text" class="form-control text-center" id="exampleInputPassword1" placeholder="Ingrese precio del condimento">
  </div>
  <div class="form-group">
    <label>Imagen</label>
