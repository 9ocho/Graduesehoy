...
<body id="page-top">
  ...
  <header class="masthead bg-secondary text-white text-center">
    ...
    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Ingrese nombre completo">
  </div>
  <div class="form-group">
   ...
   <div class="form-group">
    ...
    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Ingrese numero telefónico">
  </div>
  <div class="form-group">
...
<small class="form-text text-muted">¿Ya tienes una cuenta?<a href="" class="text-warning"> Inicia sesión</a></small>
