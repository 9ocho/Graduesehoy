...
<body id="page-top">
  ...
  <header class="masthead text-black text-center" style="background-image: url('img/paaan.jpg'); background-repeat: no-repeat;background-position: center;background-size: cover;">
       <!-- Icon Divider -->
       <h3>REGISTRAR PAN</h3>
  ...
  <div class="form-group">
    <label for="exampleInputEmail1">Nombre del pan</label>
    <input type="text" class="form-control text-center" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Ingrese nombre del pan">
  </div>
  <div class="form-group">
    <label for="exampleInputPassword1">Precio</label>
    <input type="text" class="form-control text-center" id="exampleInputPassword1" placeholder="Ingrese precio del pan">
  </div>
  <div class="form-group">
    <label>Imagen</label>
