...
<div class="container">
    <a class="navbar-brand js-scroll-trigger" href="index1.php">SANDWICHTIAN</a>
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger text-white" href="index1.php">Inicio</a>
        </li>
        <li class="mx-0 mx-lg-1">
        <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger text-white" href="index1.php#contact">Contacto</a>
        </li>
        <li class="mx-0 mx-lg-1">
