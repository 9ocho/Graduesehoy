  ...
  <header class="masthead text-black text-center" style="background-image: url('img/salsa.jpg'); background-repeat: no-repeat;background-position: center;background-size: cover;">
    ...
    <form method="post" enctype="multipart/form-data">
      <div class="form-group">
        ...
        <input type="text" name="nombre" class="form-control text-center" id="nombresl" placeholder="Ingrese nombre del condimento">
      </div>
      <div class="form-group">
        <label for="preciosl">Precio</label>
        <input type="text" name="precio" class="form-control text-center" id="preciosl" placeholder="Ingrese precio del condimento">
      </div>
      <div class="form-group">
