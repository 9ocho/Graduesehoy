...
<body id="page-top">
  ...
  <div class="form-group">
    ...
    <input type="text" name="nombre" class="form-control text-center" id="nombrepn" placeholder="Ingrese nombre del pan">
  </div>
  <div class="form-group">
    <label for="preciopn">Precio</label>
    <input type="text" name="precio" class="form-control text-center" id="preciopn" placeholder="Ingrese precio del pan">
  </div>
  <div class="form-group">
